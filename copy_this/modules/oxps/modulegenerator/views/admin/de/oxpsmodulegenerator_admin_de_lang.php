...
$aLang = array(
    'charset'                                                  => 'UTF-8',
    'oxpsmodulegenerator'                                      => 'Modulgenerator',
    'oxpsmodulegeneratormodule'                                => 'Wizard',
    'OXPS_MODULEGENERATOR_ADMIN_TITLE'                         => 'OXID Modul-Skelett Generator',

    // Settings
    'SHOP_MODULE_GROUP_oxpsModuleGeneratorVendor'              => 'Hersteller und Copyright-Einstellungen',
    'SHOP_MODULE_oxpsModuleGeneratorVendorPrefix'              => 'Hersteller-Präfix für das neue Modul. Es sollte zwei bis vier kleine lateinische Buchstaben enthalten, z.B. "abc"',
    'SHOP_MODULE_oxpsModuleGeneratorModuleAuthor'              => 'Name von Unternehmen oder Entwickler',
    'SHOP_MODULE_oxpsModuleGeneratorAuthorLink'                => 'Website URL des Modulautors',
    'SHOP_MODULE_oxpsModuleGeneratorAuthorMail'                => 'E-Mail-Adresse des Modulautors',
    ...
    'SHOP_MODULE_oxpsModuleGeneratorComment'                   => 'Kommentar-Text für PHP Dateien. Jede Zeile beginnt mit *<br/>' .
                                                                  'Normalerweise sollten hier rechtliche Hinweise und eine kurze Lizenz-Info stehen',

    'SHOP_MODULE_GROUP_oxpsModuleGeneratorTests'               => 'Modul-Test Einstellungen',
    'SHOP_MODULE_oxpsModuleGeneratorTestsGitUrl'               => 'URL eines entfernten GIT-Repository aus dem der Test-Ordner für generierte Module geklont werden soll.',
    ...
    'OXPS_MODULEGENERATOR_ADMIN_OVERRIDE_CLASSES_HINT'         => 'Liste aller zu erweiternden Klassen, eine pro Zeile z.B. "oxarticle"',
    'OXPS_MODULEGENERATOR_ADMIN_CREATE_CONTROLLERS'            => 'Controller erstellen',
    'OXPS_MODULEGENERATOR_ADMIN_CREATE_CONTROLLERS_HINT'       => 'Ein Controller-Name pro Zeile (Großbuchstaben, camel case z.B. "MyController")',
    'OXPS_MODULEGENERATOR_ADMIN_CREATE_MODELS'                 => 'Models erstellen',
    'OXPS_MODULEGENERATOR_ADMIN_CREATE_MODELS_HINT'            => 'Ein Model-Namen pro Zeile (Großbuchstaben, camel case z.B. "MyItemModel")',
    ...
    'OXPS_MODULEGENERATOR_ADMIN_CREATE_WIDGETS_HINT'           => 'Ein Widget pro Zeile (Großbuchstaben, camel case z.B. "MyWidget")',
    'OXPS_MODULEGENERATOR_ADMIN_CREATE_BLOCKS'                 => 'Blocks erstellen',
    'OXPS_MODULEGENERATOR_ADMIN_CREATE_BLOCKS_HINT'            => 'Ein Block pro Zeile (Name und Template-Pfad, kleingeschrieben und durch "@" getrennt, ein Paar pro Zeile z.B. "details_productmain_title@page/details/inc/productmain.tpl")',
    'OXPS_MODULEGENERATOR_ADMIN_MODULE_SETTINGS'               => 'Modul-Einstellungen erstellen',
    ...
    'OXPS_MODULEGENERATOR_ADMIN_MODULE_ERROR_NO_VENDOR'        => 'Achtung! Hersteller oder Autor-Parameter sind nicht konfiguriert.<br/>' .
                                                                  'Bitte öffnen Sie <i>Erweiterungen -> Module -> OXID Modul-Skelett Generator -> Einstell. -> Hersteller und Copyright Einstellungen</i> ' .
    ...
    'OXPS_MODULEGENERATOR_ADMIN_MODULE_MSG_GENERATION_SUCCESS' => 'Ihr Modul wurde erfolgreich generiert! Bitte prüfen Sie es in <i>Erweiterungen -> Module</i> und den Source-Code in Ihrem Hersteller-Verzeichnis.'
);
